...
class PhotoGridAdapter( val onClickListener: OnClickListener ) :
    ...
    class CatalogItemViewHolder(private var binding: GridViewItemBinding):
        ...
        fun bind(marsProperty: CatalogItem) {
     ...
     */
    class OnClickListener(val clickListener: (marsProperty:CatalogItem) -> Unit) {
        fun onClick(marsProperty:CatalogItem) = clickListener(marsProperty)
    }
}